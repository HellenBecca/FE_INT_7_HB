...
var num1 = parseFloat(prompt("please enter your first number:")); // Validates num1
...
var action = prompt("Choose an action: +, -, /, or *"); // Validates action
...
var num2 = parseFloat(prompt("please enter your second number:")); // Validates num2 and if division with 0, display an error message
...
alert("The result is: ".concat(result));