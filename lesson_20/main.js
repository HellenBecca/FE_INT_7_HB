...
const car = {
    ...
    displayCarInfo() {
        ...
        console.log(`this.avarageSpeed;${this.avarageSpeed}`);
    },
    ...
    calculateTime(distance) {
        const drivingHours = distance / this.avarageSpeed; // Total driving time in hours
        const breaks = Math.floor(drivingHours / 4); // 1 hour break per 4th hour 
...
car.displayCarInfo();
console.log(`Time required for 300 km: ${car.calculateTime(300)} hours`)
    ...
    displayTime() {
        console.log(
            `${this.hours.toString().padStart(2, "0")}:${this.minutes
              .toString()
              .padStart(2, "0")}:${this.seconds.toString().padStart(2, "0")}`//The padStart() method of String values pads this string with another string
        );
    },
